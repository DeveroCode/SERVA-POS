          ...
          <div className="flex items-end justify-between -mt-8 mb-3.5">
            ...
            <div className="flex items-center gap-1.5 pt-8">
              <button
                ...
                className="p-2 rounded-xl text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors duration-200 focus:outline-none"
              >
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 mt-1 w-44 bg-white rounded-2xl border border-slate-200/90 shadow-lg shadow-slate-900/10 py-1.5 z-20 text-xs font-medium text-slate-700">
                      <a
                        href={`https://serva.app/${business.slug}`}
                        target="_blank"
                        rel="noreferrer"
                      ...
                      <button
                        type="button"
                        className="w-full text-left flex items-center gap-2 px-3.5 py-2 hover:bg-slate-50 transition-colors text-slate-700"
                        onClick={() => setIsDropdownOpen(false)}
                      >
